...
void setup() {
  ...
  lcd.clear();
  lcd.setCursor(0,0);
  lcd.print("Conectado ao ELM327 com sucesso!");
...
void printValues(){
  ...
  Serial.println("ENG_L | = " + String(engineLoad));
  Serial.println("COL_P | = " + String(manifoldPressure));
  Serial.println("VEL   | = " + String(kph));
  Serial.println("TPS   | = " + String(tps));
  Serial.println("ENG_T | = " + String(engineTemp));
  Serial.println("---------------------------------------");
}
